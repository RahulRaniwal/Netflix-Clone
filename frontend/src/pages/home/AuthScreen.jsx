  ...
  return (
    <div className="hero-bg relative">
      ...
      <div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
        ...
        >
          {() => (
            <Form className='flex flex-col md:flex-row gap-4 w-1/2 mx-auto'>
              <div className='flex-1'>
                <TextField
                  name="email"
                  type="email"
                  placeholder="example@email.com"
                  className='p-3 rounded bg-black/80 border border-gray-700 w-full'
                />
              </div>
              <div className='flex-none'>
                <button
                  className='bg-red-600 text-xl lg:text-2xl px-4 lg:px-6 py-1 md:py-2 rounded flex justify-center items-center mt-1'
                >
                  Get Started
        ...
        <div className='py-10 bg-black text-white'>
          <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
            ...
            <div className='flex-1 text-center md:text-left'>
              ...
              <p className='text-lg md:text-xl'>Watch on Smart TVs, PlayStation, XBox, Chromecast, Apple TV, Blu-ray palyers, and more.</p>
            </div>
            {/* right section */}
        ...
        <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
          ...
          <div className='flex-1'>
            <div className='relative'>
              <img src="/stranger-things-lg.png" alt="Strangers Things"  className='mt-4'/>
